...
// /* 0x00cc */ char gameName[0x40];
// /* 0x010c */ char gamePassword[0x18];
// /* 0x0124 */ enum eNW_STATE state;
// /* 0x0125 */ char unk_0125[0x3];
// /* 0x0128 */ char unk_0128[0xc];
// /* 0x0134 */ int unk_0134;
...
// /* 0x12da */ char unk_12da[0x9a];
// /* 0x1374 */ int gameWorldId;
// } tNW_Info_t;

// got from Ghidra.
// The above tNW_Info struct is off.
// m_GuiSetRefreshCallback is +0x4 of where it should be.
typedef struct tNW_Info {
    char unk_0000[16];
    int numLocalPlayers;
    void *myConnectionIndex;
    int myClientIndex;
    u32 uniqueIdCnt;
    int unk_0020;
    int gameLevel;
    ...
    char clientIndex[8];
    char unk_0160[24];
    char isSessionMaster;
    char isNewSessionMaster;
    char pad_017a[2];
    int sessionMasterClientIndex;
    int onlyLocalPlayers;
    int originalyOnlyLocalPlayers;
    char INukedTheMicroCode;
    char unk_0189[2];
    char m_bPeer2PeerGame;
    char unk_018c;
    char unk_018d[3];
    char m_bUseEncryption;
    char m_bZeroAggregation;
    char myIP[32];
    char field49_0x1b2[298];
    void *m_GuiSetBusyCallback;
    void *m_GuiSetRefreshCallback;
    int m_LastMediusError;
    int m_LastMGCLError;
    int m_LastNetError;
    int m_LastMediusNetError;
    char unk_02fc[408];
    int m_bForcePlayerReport;
    int m_LastPlayerReportTime;
    int m_bForceWorldReport;
    int m_LastWorldReportTime;
    char unk_04a4[20];
    int gameSequenceNumber;
    char unk_04bc[328];
    int maxPlayers_2;
    char unk_0600[48];
    int m_bUpdateClanStatsPending;
    int m_UpdateClanStatsStatus;
    int m_bAccountUpdateStatsPending;
    int m_AccountUpdateStatsStatus;
    int unk_0640;
    int m_JoinResponse;
    int superCheat;
    int unk_064c;
    ...
    int unk___ClientSettings_2;
    int receivedMessagePlayerIdx;
    char unk_069c[32];
    char m_bSessionMasterLagging;
    char clientIndexRemapper[8];
    char unk_06c5[251];
    int m_LastUdpPacketReceived[8];
    int m_LastUdpPacketReceivedFromAnyone;
    char m_RussiaHouseTransportFlagHack;
    char unk_07e5[8];
    char bNewSessionMaster;
    char unk_07ee[130];
    int unk_0870[2];
    int unk_0878[2];
    int unk_0880[2];
