...
enum MobyId
{
	...
	MOBY_ID_AQUATOS_SEWERS_WATER = 0x093e,
	...
	MOBY_ID_TROOPER_TORSO = 0x109e,
	MOBY_ID_TROOPER_LEGS = 0x109f,
	...
	MOBY_ID_BALL_BOT_SPAWNER = 0x19f6,
...
void mobySetState(Moby *pMoby, char state, char stateType);
