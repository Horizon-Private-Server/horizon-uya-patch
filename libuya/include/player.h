...
typedef struct HeroJump { // 0x100
	...
	/* 0x60 */ char unk_60[0x20];
	/* 0x84 */ float XySpeedMultiplayer;
	/* 0x88 */ float ideal_height;
	/* 0x8c */ short int pushOffTime;
	/* 0x8e */ short int unk_8e;
	/* 0x90 */ char unk_90[0x8];
	/* 0x98 */ float coll_bot;
	/* 0x9c */ char unk_9c[0xc];
	/* 0xa8 */ float peakFrm;
	/* 0xac */ float landFrm;
	/* 0xb0 */ float gameLandFrm;
	/* 0xb4 */ char unk_b4[0x44];
	/* 0xe8 */ float minHeight;
	/* 0xec */ float maxHeight;
	/* 0xf0 */ float fallThresh;
	/* 0xf4 */ char unk_f4[4];
	/* 0xf8 */ short int maxUpTime;
	/* 0xfa */ short int bailoutSafetyTime;
