...
typedef struct HeroJump { // 0x100
	/* 0x000 */ struct HeroJumpNonParab nonParab;
	/* 0x030 */ VECTOR takeoffPos;
	/* 0x040 */ VECTOR snapJumpThrustVec;
	/* 0x050 */ VECTOR snapJumpForwardVec;
	/* 0x060 */ char unk_60[0x24];
	/* 0x084 */ float XySpeedMultiplayer;
	/* 0x088 */ float ideal_height;
	/* 0x08c */ short int pushOffTime;
	/* 0x08e */ char unk_8e[0xa];
	/* 0x098 */ float coll_bot;
	/* 0x09c */ char unk_9c[0xc];
	/* 0x0a8 */ float peakFrm;
	/* 0x0ac */ float landFrm;
	/* 0x0b0 */ float gameLandFrm;
	/* 0x0b4 */ char unk_b4[0x24];
	/* 0x0d8 */ float minHeight;
	/* 0x0dc */ float maxHeight;
	/* 0x0e0 */ float fallThresh;
	/* 0x0e4 */ char unk_d4[0x4];
	/* 0x0e8 */ short int maxUpTime;
	/* 0x0ea */ short int bailoutSafetyTime;
	/* 0x0ec */ char unk_dc[0x4];
	/* 0x0f0 */ float gravity;
	/* 0x0f4 */ char unk_104[0x8];
	/* 0x0fc */ char gloveAttackOk;
	/* 0x0fd */ char strafingFlip;
	/* 0x0fe */ char flipJumpOk;
	/* 0x0ff */ char doubleJumpOk;
} HeroJump;
