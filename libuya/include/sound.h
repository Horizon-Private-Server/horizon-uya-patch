...
struct _sound_data { // 0x80
	...
	/* 0x0e */ short unsigned int occlpos;
	/* 0x10 */ char status;
	/* 0x11 */ char loop;
	/* 0x12 */ char priority;
	/* 0x13 */ char unused0;
	...
	/* 0x20 */ VECTOR pos;
	/* 0x30 */ VECTOR offset;
	/* 0x40 */ SoundInstance *pAmbient;
	/* 0x44 */ int lineEmitter;
	/* 0x48 */ int oClass;
	/* 0x4c */ float pan;
	/* 0x50 */ int delay;
	/* 0x54 */ int flags;
	/* 0x58 */ short unsigned int unique_id;
	/* 0x5a */ short unsigned int pad16_0;
	/* 0x5c */ char occl[36];
};
...
typedef struct _sound_globals { // 0x1d30
	...
	/* 0x02a8 */ SoundInstance *pReverbOwner;
	/* 0x02ac */ int reverb_depth;
	/* 0x02b0 */ int ambientCnt;
	/* 0x02b4 */ SoundInstance *pAmbient;
	/* 0x02c0 */ _sound_data channels[52];
	/* 0x1cc0 */ VECTOR cam_ofs[6];
	/* 0x1d20 */ unsigned int volFlags;
